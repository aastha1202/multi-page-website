...
function Technology()
{
   const [toggleState,setToggleState]= useState(1);
    ...
    backgroundPosition:"center",
     ...
     <h1 className="common-text"> <span>03</span>Space launch 101</h1>
     ...
     <div className="tech_container">
        <div className="content_wrapper">
            ...
            <div className= { toggleState === 1 ? 'contents active_contents' : 'contents'} >
                ...
                <div className= { toggleState === 2 ? 'contents active_contents' : 'contents'} >
                    <span> The terminology... </span>
                    <h1> Spaceport </h1>
                    <p>
                ...
                <div className= { toggleState === 3 ? 'contents active_contents' : 'contents'} >
                    <span> The terminology... </span>
                    <h1> Space capsule </h1>
                    <p>
